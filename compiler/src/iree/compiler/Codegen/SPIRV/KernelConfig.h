...
constexpr unsigned defaultSimtSoftwarePipelineDepth = 0;
constexpr unsigned defaultSimtSoftwarePipelineStoreStage = 2;

constexpr unsigned defaultCoopMatrixSoftwarePipelineDepth = 1;
constexpr unsigned defaultCoopMatrixSoftwarePipelineStoreStage = 1;
