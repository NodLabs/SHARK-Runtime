...
static const iree_hal_buffer_vtable_t iree_hal_level_zero_buffer_vtable;

static iree_hal_level_zero_buffer_t* iree_hal_level_zero_buffer_cast(
    iree_hal_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &iree_hal_level_zero_buffer_vtable);
...
iree_status_t iree_hal_level_zero_buffer_wrap(
  ...
  iree_hal_level_zero_buffer_t* buffer = NULL;
  ...
  if (iree_status_is_ok(status)) {
    iree_hal_buffer_initialize(
        ...
        &iree_hal_level_zero_buffer_vtable, &buffer->base);
...
static void iree_hal_level_zero_buffer_destroy(iree_hal_buffer_t* base_buffer) {
...
static iree_status_t iree_hal_level_zero_buffer_map_range(
...
static iree_status_t iree_hal_level_zero_buffer_unmap_range(
...
static iree_status_t iree_hal_level_zero_buffer_invalidate_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
...
static iree_status_t iree_hal_level_zero_buffer_flush_range(
    iree_hal_buffer_t* base_buffer, iree_device_size_t local_byte_offset,
    iree_device_size_t local_byte_length) {
  // Nothing to do.
  return iree_ok_status();
...
static const iree_hal_buffer_vtable_t iree_hal_level_zero_buffer_vtable = {
    ...
    .destroy = iree_hal_level_zero_buffer_destroy,
    .map_range = iree_hal_level_zero_buffer_map_range,
    .unmap_range = iree_hal_level_zero_buffer_unmap_range,
    .invalidate_range = iree_hal_level_zero_buffer_invalidate_range,
    .flush_range = iree_hal_level_zero_buffer_flush_range,
};
