...
function(iree_check_single_backend_test_suite)
  ...
  if(DEFINED _RULE_DRIVER)
    ...
    if((NOT DEFINED IREE_HAL_DRIVER_${_NORMALIZED_DRIVER}) AND (NOT ${_NORMALIZED_DRIVER} IN_LIST _NORMALIZED_EXTERNAL_DRIVERS) AND (NOT ${_RULE_DRIVER} STREQUAL "level_zero"))
      message(SEND_ERROR "Unknown driver '${_RULE_DRIVER}'. Check IREE_HAL_DRIVER_*/IREE_EXTERNAL_HAL_DRIVERS options.")
    endif()
    if((NOT IREE_HAL_DRIVER_${_NORMALIZED_DRIVER}) AND (NOT IREE_EXTERNAL_${_NORMALIZED_DRIVER}_HAL_DRIVER_FOUND) AND (NOT ${_RULE_DRIVER} STREQUAL "level_zero"))
      return()
    endif()
  endif()
